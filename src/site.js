...
function finalCta() {
  return `<section class="final-cta"><div class="container cta-inner"><div>${eyebrow('VOTRE PROJET')}<h2>Discutons de votre site.</h2><p>Présentez-nous votre activité et ce que vous souhaitez créer ou améliorer.</p></div><a class="button" href="/contact/">Parler de votre projet${diagonal}</a></div></section>`;
}
