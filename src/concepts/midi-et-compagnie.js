...
export function renderMidi() {
  ...
  <script src="${assetUrl('/concepts/navigation.js')}" defer></script>
    ...
    <div class="concept-strip"><div class="wrap"><span>Projet conceptuel — entreprise fictive</span><a href="/realisations/">← Retour à Baerg</a></div></div>
    ...
    <main id="contenu" tabindex="-1">
      <section class="hero" aria-labelledby="hero-title"><div class="wrap">
        ...
        <figure class="hero-photo"><picture><source media="(max-width: 700px)" srcset="${assetUrl(base + '/images/dejeuner-stock-mobile.webp')}" width="720" height="900"><img src="${assetUrl(base + '/images/dejeuner-stock.webp')}" alt="Plusieurs assiettes de viande, de salade et de pain sur une table en bois, avec des verres et des serviettes en tissu, en lumière naturelle." width="1600" height="800" fetchpriority="high"><\/picture><figcaption>Photographie d’illustration</figcaption></figure>
      </div></section>
      <section class="menu-section" id="carte" tabindex="-1" aria-labelledby="menu-title"><div class="wrap">
        ...
        <div class="menu-layout"><aside class="menu-aside" aria-label="Inspiration du dessert"><figure><img src="${assetUrl(base + '/images/tarte-stock.webp')}" srcset="${assetUrl(base + '/images/tarte-stock-mobile.webp')} 640w, ${assetUrl(base + '/images/tarte-stock.webp')} 1000w" sizes="(max-width: 700px) min(430px, calc(100vw - 36px)), (max-width: 1376px) 36vw, 440px" width="1000" height="1500" loading="lazy" alt="Tarte Tatin aux poires caramélisées sur une assiette en céramique et une planche en bois, photographiée à la lumière du jour."><figcaption>Photographie d’illustration · Inspiration autour de la poire, différente de la recette de la carte.</figcaption></figure><div class="dessert-note"><p>On garde une petite place ?</p><span>La tarte poire & amande</span><strong>8 CHF</strong></div></aside>
        <div class="menu-board"><div class="filters" role="group" aria-label="Filtrer la carte" hidden><button type="button" data-filter="all" aria-pressed="true">Tout</button><button type="button" data-filter="entrees" aria-pressed="false">Entrées</button><button type="button" data-filter="plats" aria-pressed="false">Plats</button><button type="button" data-filter="desserts" aria-pressed="false">Desserts</button></div>
          ...
          <p class="menu-footnote">Une carte imaginée pour ce concept. La réservation est indisponible : aucune demande n’est envoyée et aucune donnée personnelle n’est collectée.</p>
        </div></div>
      </div></section>
      <section class="hours-section" id="horaires" tabindex="-1" aria-labelledby="hours-title"><div class="wrap hours-layout">
